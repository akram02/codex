#!/usr/bin/env python3
"""Stage and optionally package the @akramkhan/codex npm module."""
...
CODEX_NPM_NAME = "@akramkhan/codex"
CODEX_NPM_README = CODEX_CLI_ROOT / "README.npm.md"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@akramkhan/codex`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@akramkhan/codex-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@akramkhan/codex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@akramkhan/codex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@akramkhan/codex-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@akramkhan/codex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@akramkhan/codex-win32-arm64",
        "npm_tag": "win32-arm64",
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        if CODEX_NPM_README.exists():
            shutil.copy2(CODEX_NPM_README, staging_dir / "README.md")
        ...
        if isinstance(homepage, str):
            package_json["homepage"] = homepage

        bugs = codex_package_json.get("bugs")
        if isinstance(bugs, (dict, str)):
            package_json["bugs"] = bugs
